  ...
  return (
    <div className='w-[100%] h-screen'>
       ...
       font-title text-[50px] flex justify-center items-center '><i>TeamName Team</i></div>
        <div className='bg-[#EBEAE6] w-full h-[110vh] flex justify-start' id='name1'>
        ...
        <div className='bg-white w-full h-[90vh] flex justify-start ' id='name2'>
              <div className='w-[50%] flex justify-end mt-[30px]' id='name2'>
        ...
        <div className='bg-[#EBEAE6] w-full h-[90vh] flex justify-start' id='name3'>
        ...
        <div className='bg-white w-full h-[90vh] flex justify-start' id='name4'>
              <div className='w-[50%] flex justify-end mt-[30px]'>
                <img src="./public/image3.png" alt="" className='h-[425px] w-[425px]'/>
              </div>
              <div className='w-[50%] flex justify-start flex-col p-[50px] pl-[60px]'>
        ...
        <div className='bg-[#EBEAE6] w-full h-[90vh] flex justify-start' id='name5'>
              <div className='w-[50%] flex justify-end mt-[30px]'>
                <img src="./public/image3.png" alt="" className='h-[425px] w-[425px]'/>
              </div>
              <div className='w-[50%] flex justify-start flex-col p-[50px] pl-[60px]'>
        ...
        <div className='bg-white w-full h-[90vh] flex justify-start' id='name6'>
              <div className='w-[50%] flex justify-end mt-[30px]'>
                <img src="./public/image3.png" alt="" className='h-[425px] w-[425px]'/>
              </div>
              <div className='w-[50%] flex justify-start flex-col p-[50px] pl-[60px]'>
        ...
        <div className='bg-[#EBEAE6] w-full h-[90vh] flex justify-start' id='name7'>
              <div className='w-[50%] flex justify-end mt-[30px]'>
                <img src="./public/image3.png" alt="" className='h-[425px] w-[425px]'/>
              </div>
              <div className='w-[50%] flex justify-start flex-col p-[50px] pl-[60px]'>
        ...
        <div className='bg-white w-full h-[90vh] flex justify-start' id='name8'>
              <div className='w-[50%] flex justify-end mt-[30px]'>
                <img src="./public/image3.png" alt="" className='h-[425px] w-[425px]'/>
              </div>
              <div className='w-[50%] flex justify-start flex-col p-[50px] pl-[60px]'>
        ...
        <div className='bg-[#EBEAE6] w-full h-[90vh] flex justify-start' id='name9'>
              <div className='w-[50%] flex justify-end mt-[30px]'>
                <img src="./public/image3.png" alt="" className='h-[425px] w-[425px]'/>
              </div>
              <div className='w-[50%] flex justify-start flex-col p-[50px] pl-[60px]'>
        ...
        <div className='bg-white w-full h-[90vh] flex justify-start' id='name10'>
              <div className='w-[50%] flex justify-end mt-[30px]'>
                <img src="./public/image3.png" alt="" className='h-[425px] w-[425px]'/>
              </div>
              <div className='w-[50%] flex justify-start flex-col p-[50px] pl-[60px]'>
        ...
        <div className='bg-[#EBEAE6] w-full h-[90vh] flex justify-start' id='name11'>
              <div className='w-[50%] flex justify-end mt-[30px]'>
                <img src="./public/image3.png" alt="" className='h-[425px] w-[425px]'/>
              </div>
              <div className='w-[50%] flex justify-start flex-col p-[50px] pl-[60px]'>
